...
[L1] = LAYOUT_planck_mit( /* BASE QWERTY LAYER */
  ...
  KC_EQL,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_CAPS,
  RGB_TGL, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT,     KC_ENT,      LT2_SPC, KC_RGUI, KC_RALT, KC_RCTL, MO(L4)
),
...
[L3] = LAYOUT_planck_mit( /* NUM PAD AND F KEYS */
  ...
  KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_B,    KC_NO,   KC_1,    KC_2,    KC_3,    KC_GRV,  KC_TRNS,
  KC_TRNS, TO_L5,   KC_TRNS, KC_TRNS, KC_TRNS,     KC_ENT,       KC0_FLY, KC_TRNS, KC_TRNS, KC_TRNS, RESET
),
...
[L4] = LAYOUT_planck_mit( /* MAGNET FOR MACOSX SHORTCUTS */
  ...
  KC_TRNS, TO_L5,   KC_TRNS, KC_TRNS, KC_TRNS,     KC_ENT,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO
),
...
[L6] = LAYOUT_planck_mit( /* Function key layer */
  KC_ESC,  KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_T,    KC_Y,     KC_F21,  KC_F22,  KC_F23,  KC_F24,  KC_BSPC,
  KC_TAB,  KC_F5,   KC_F6,   KC_F7,   KC_F8,  KC_G,    KC_H,     KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_ENT,
  KC_LSFT, KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_B,    KC_N,     KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_RSFT,
  KC_NO,   KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,    KC_BSPC,        KC_TRNS, KC_RGUI, KC_RALT, KC_RCTL, TO_L1
